...
const (
	...
	OKMultiDiscOrganization   = "Release is not multi-disc, or files from multiple discs are either in top folder with disc numbers in filenames, or in dedicated subfolders."
	KOMultiDiscOrganization   = "Tracks from this multi-disc release are incorrectly organized."
